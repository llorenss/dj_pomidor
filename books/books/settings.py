...
# from dj_pomidor.passw import *
# import sys
# from sys.path.append("/mnt/c/python/dj_pomidor/passw.py") import *
...
SECRET_KEY = 'django-insecure--)@t^u#n+58fm0b94867%f3k90^^y%!h0c4pue_*)n$x)y8vuw'
